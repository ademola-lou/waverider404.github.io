...
function AmmoMesh( geometry, mesh, shape, makeStatic ) {
  ...
  var init = function() {
    ...
    if ( geometry instanceof THREE.SphereGeometry ) {
     ...
     if(shape === "convex") this.rigidBody = Ammo.Utils.createStaticConvexHull( points, mesh );
    ...
    if(shape === "concave")this.rigidBody = Ammo.Utils.createStaticConcave( triangles, mesh );
      
    if(shape === "box")this.rigidBody = Ammo.Utils.createStaticBox(this.width, this.height, this.depth, mesh);
    }
